...
export function Traveler({ size = 220, shirt = '#7950D5', backpack = '#DB943A', hat = { style: 'cap', color: '#83BE52' } }: { size?: number } & Partial<Appearance>) {
  return <Svg width={size} height={size * 1.18} viewBox="0 0 220 260" aria-hidden={true}>
    ...
    <Rect x={139} y={130} width={37} height={71} rx={16} fill={backpack} />
    <Rect x={151} y={145} width={27} height={33} rx={10} fill={backpack} stroke="white" strokeOpacity={0.25} strokeWidth={3} />
    ...
    <Headwear style={hat.style} color={hat.color} />
  </Svg>;
}
